...
You can either install the [Visual Studio 2013 Preview](http://www.microsoft.com/visualstudio/eng/2013-preview) or use the existing Visual Studio 2012 installation and download the newest version from Nuget: (currently 5.0.0-beta2)
...
&nbsp;&nbsp; __[&raquo; Download Demo-Code (.zip)](xxxhttp://dl.bintray.com/johanneshoppe/DeveloperMediaDemo/DeveloperMediaWebinar_Knockout_Teil2_SinglePage.zip?direct)__
