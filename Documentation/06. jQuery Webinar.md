...
<div id="index_template" class="container">
	...
	<p class="alert alert-info">
    	The following list was rendered with Knockout and styled via the default boostrap theme.
	</p> 
